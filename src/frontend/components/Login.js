      ...
      try {
        ...
        if (isCustomer) {
          ...
          if (isMember) {
            ...
            swal("Oops!", "You are not Registered in our portal. Kindly Register to Login ", "error");
      ...
      <div>
        <div className='sign-up'>
          ...
          <div className='text'>
            ...
            <input placeholder=' example: 243'  onChange={onChange} />
          </div>
          <div className='text'>
          ...
          <p></p>
          <button className='button_login' onClick={web3Handler}>Connect Wallet</button>
